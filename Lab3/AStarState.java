...
public class AStarState
{
    ...
    public Waypoint getMinOpenWaypoint()
    {
        ...
        Set open_waypoint_keys = this.openWaypoints.keySet();
        ...
        while (i.hasNext()) {
            ...
            Waypoint waypoint = this.openWaypoints.get(location);

            float waypoint_total_cost = waypoint.getTotalCost();

            if (waypoint_total_cost < best_cost) {
                best = this.openWaypoints.get(location);
    ...
    public boolean addOpenWaypoint(Waypoint newWP)
    {
        ...
        if (this.openWaypoints.containsKey(location)) {
            Waypoint current_waypoint = this.openWaypoints.get(location);
            if (newWP.getPreviousCost() < current_waypoint.getPreviousCost()) {
                this.openWaypoints.put(location, newWP);
    ...
    {
        Waypoint waypoint = this.openWaypoints.remove(loc);
        this.closedWaypoints.put(loc, waypoint);
    }
